...
**Automation / PS5 Remote Play (optional):**
...
NBA2K_Workshop\
  ...
  Documents\                    Meta-docs (+ .txt mirrors for NotebookLM / Drive sync)
  ...
  requirements.txt
  README.md                     short pointer → Documents/README.md
...
See **`Documents/PLAN.md`** for the complete architecture and phase roadmap.

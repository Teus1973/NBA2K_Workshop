...
def test_normalize_full_name_collapses_dot_initials() -> None:
    assert normalize_full_name("A.J. Dybantsa") == "aj dybantsa"
...
def test_height_in_to_ft_str_fractional_inches():
    assert height_in_to_ft_str(
        75.75,
        fractional_inches=True,
    ) == "6' 3.75\""
